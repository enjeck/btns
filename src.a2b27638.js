...
var myClass = "";
var myStylesheet = $.makeArray(document.styleSheets[0].cssRules).filter(function (_ref) {
  var selectorText = _ref.selectorText;
  return selectorText && selectorText.includes(myClass);
});
$(function () {
  $(".btn").on("click", function () {
    $(".css-code").empty();
    var thisButton = $(this);
    var classes = thisButton.attr("class").split(" ");
    classes.forEach(function (item1, index, array) {
      // Create class selector
      item1 = "." + item1;
      myClass = item1; //console.log(thisButton);
...
function getSelectorCss(selector, stylesheet) {
  ...
  stylesheet.forEach(function (item, index, array) {
    ...
    var finalSelector = ""; // If mySelector matches:

    if (matchingSelector !== null) {
      //If mySelector contains commas, split it into an array
      var selectorLoopResult = ""; // the ultimate selector used for final result
      //console.log(mySelector);
      //console.log(thisButton);

      if (mySelector.match(/,/)) {
        //if mySelector has commas:
        var mySelectorArray = mySelector.split(","); //split into array where commas separate items
      ...
      var itemCss = item.cssText;
      itemCss = itemCss.substring(itemCss.indexOf("{"));
      itemCss = itemCss.replace(/[{}]/g, "");
      var theSelectorIndex = theSel.indexOf(selectorLoopResult); //If selector already in the array, find its corresponding CSS
      ...
      if (theSelectorIndex === -1) {
        ...
        var newCssRule = theCss[theSelectorIndex] + itemCss;
...
function cleanArray(array) {
  ...
  while (array.length > 0) {
    var cssItem = array[array.length - 1];
    array2.push(cssItem);
    array.pop();
  }
...
$(function () {
  ...
  $("#copy-html").on("click", function () {
    ...
    var copyText = document.getElementById("cliphold");
    copyText.select();
